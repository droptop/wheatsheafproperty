...
export default function Sustainability() {
  ...
  return (
    <section id="sustainability" className="py-24 bg-slate-dark text-off-white">
          ...
          <div className="lg:w-1/2 w-full flex flex-col gap-12">
            {values.map((item, index) => (
              <ScrollReveal key={index} delay={index * 0.15}>
                <div className="border-l border-accent/20 pl-10 py-2 group hover:border-accent transition-colors duration-500">
