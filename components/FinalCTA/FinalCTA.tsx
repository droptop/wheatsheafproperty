            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" id="name" className="w-full bg-transparent border-b border-off-white/20 py-3 focus:outline-none focus:border-accent transition-colors" placeholder="John Doe" />
                </div>
                <div className="space-y-2">
                  <label htmlFor="email" className="text-xs font-bold uppercase tracking-widest text-off-white/40">Email Address</label>
                  <input type="email" id="email" className="w-full bg-transparent border-b border-off-white/20 py-3 focus:outline-none focus:border-accent transition-colors" placeholder="john@example.com" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <textarea id="message" rows={4} className="w-full bg-transparent border-b border-off-white/20 py-3 focus:outline-none focus:border-accent transition-colors resize-none" placeholder="How can we help?"></textarea>
              </div>
              <button type="submit" className="w-full py-5 bg-accent text-brand-dark font-bold uppercase tracking-[0.2em] text-sm hover:bg-accent/90 transition-all duration-300">
